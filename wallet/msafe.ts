...
assert(
    computedMsafeAddress0 === msafeAddress0,
    `Expected ${msafeAddress0}, got ${computedMsafeAddress0}`,
);
console.log(
    'Additional pk with flag for computedMsafeAddress0',
    noncePublicKey(inputData0.nonce).publicKey.toIotaPublicKey(),
);
...
assert(
    computedMsafeAddress1 === msafeAddress1,
    `Expected ${msafeAddress1}, got ${computedMsafeAddress1}`,
);
console.log(
    'Additional pk with flag for computedMsafeAddress1',
    noncePublicKey(inputData1.nonce).publicKey.toIotaPublicKey(),
);
