...
(async () => {
    const ownedObjects = await client.getDynamicFieldObject({
        parentObjectId: '0x82139fa7c076816b67e2ff0927f2b30e4d6e2874a3a108649152a7b7d9eb25ac',
        name: {
            type: 'address',
    ...
    const ownedObjects2 = await client.getDynamicFieldObject({
        parentObjectId: '0xd48c0a882059036ca8c21dcc8d8bcaefc923aa678f225d3d515b79e3094e5616',
        name: {
