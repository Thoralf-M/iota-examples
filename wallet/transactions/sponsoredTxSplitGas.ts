...
(async () => {
    ...
    const transfersFromGas = [
        { address: '0xa1a97d20bbad79e2ac89f215a3b3c4f2ff9a1aa3cc26e529bde6e7bc5500d610', amount: 2_000_000 },
    ]
    const coinsFromGas = txb.splitCoins(
        txb.gas,
        [transfersFromGas[0].amount, transfers[0].amount / 2],
    );
    ...
    const transfersFromGasAndSender =
        { address: '0xb875c1dd25c456f9221fbd62fc83f83b06e22f79733fce62c2b9cbcf234d2400', amount: 2_000_000 };
